...
$fileName = sprintf('%s_common_%s_%s_%s.jpg', $installationNumber, preg_replace('/[^a-z0-9_\-]/i', '_', $photoCode), $dt, $rand);
...
$stmt = db()->prepare('INSERT INTO installation_photos (installation_id, scope, photo_code, photo_stage, title, file_path, thumb_path, mime_type, file_size, width, height, uploaded_by, uploaded_at) VALUES (:installation_id,:scope,:photo_code,:photo_stage,:title,:file_path,:thumb_path,:mime_type,:file_size,:width,:height,:uploaded_by,:uploaded_at)');
$stmt->execute([
